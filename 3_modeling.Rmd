...
save(snps_AMR_all_map, file = paste0(raw_data_path, "Interpretation/snps_AMR_all_map.rda"))
# Step 2: fit LASSO
...
varimp_AMR_all_map = snp.lasso.all.map@model$variable_importances
save(varimp_AMR_all_map, file = paste0(raw_data_path, "Interpretation/varimp_AMR_all_map.rda"))
```
...
save(snps_AFR_all_map, file = paste0(raw_data_path, "Interpretation/snps_AFR_all_map.rda"))
# Step 2: fit LASSO
...
aml_all_map = h2o.automl(x = X, y = Y, training_frame = target.train, 
                           ...
                           include_algos = "GLM")
snp.lasso.all.map = aml_all_map@leader
varimp_AFR_all_map = snp.lasso.all.map@model$variable_importances
save(varimp_AFR_all_map, file = paste0(raw_data_path, "Interpretation/varimp_AFR_all_map.rda"))
```
...
save(snps_EAS_all_map, file = paste0(raw_data_path, "Interpretation/snps_EAS_all_map.rda"))
# Step 2: fit LASSO
...
aml_all_map = h2o.automl(x = X, y = Y, training_frame = target.train, 
                           ...
                           include_algos = "GLM")
snp.lasso.all.map = aml_all_map@leader
varimp_EAS_all_map = snp.lasso.all.map@model$variable_importances
save(varimp_EAS_all_map, file = paste0(raw_data_path, "Interpretation/varimp_EAS_all_map.rda"))
```
